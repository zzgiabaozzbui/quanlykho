 ...
 * @author ADMIN
 */
public class TTPhieuXuat extends javax.swing.JPanel {

    /**
     * Creates new form TTPhieuXuat
     */
    TTPhieuXuatControl xc=new TTPhieuXuatControl(this);
    int ma;
    public TTPhieuXuat(int maPX) {
        ma=maPX;
        initComponents();
        table.setDefaultEditor(Object.class, null);
        table.getTableHeader().setFont(new Font("Arial", Font.BOLD, 18));
        table.setModel(xc.getModelTable(maPX));
    }
    ...
    public void next(int key)
    {
        ...
        JPanel themCT=new ThemCTPX(key);
        this.add(themCT);
        this.validate();
        this.repaint();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Cập nhật phiếu xuất");
    ...
    public void reset()
    {
        this.removeAll();
        this.setLayout(new CardLayout());
       JPanel themCT=new TTPhieuXuat(ma);
        this.add(themCT);
        this.validate();
        this.repaint();
    }
    private void btnAdd1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdd1ActionPerformed
        try {
            ...
            if(k==0)
            {
                ...
                ctx.setMaCTXuat(Integer.parseInt(value));
                ctx.setSoLuong(Integer.parseInt(value1));
                ctx.setGiaXuat(Float.parseFloat(value2));
                ctx.setMaXuat(Integer.parseInt(value3));
                xc.delete(ctx);
            }
        } catch (Exception e) {
