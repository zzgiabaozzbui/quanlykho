 ...
 * @author ADMIN
 */
public class ThemPhieuXuat extends javax.swing.JPanel {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            int k=JOptionPane.showConfirmDialog(null,"Bạn có muốn thêm phiếu xuất "+table.getModel().getValueAt(row, 1).toString()+" ? ");
            if(k==0)
            {
                xuat xuat=new xuat();
